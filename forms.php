               ...
               <div class="glass-card mb-2">
                 <div class="row">
                   ...
                   <div class="col-md-4">
                     ...
                     <div class="mb-2">
                       <label for="memberType" class="form-label">সদস্যের ধরন: <span class="text-secondary small">(Member Type)</span>
                       </label>
                     ...
                     <div class="mb-2">
                       <label for="project" class="form-label">প্রকল্প নির্ধারণ: <span class="text-secondary small">(Project Definition)</span>
                       </label>
                       <select class="form-select" id="project" name="project" required>
                         <option value="">নির্বাচন করুন (Select)</option>
                         <?php foreach($projects as $project): ?>
                         <option value="<?php echo htmlspecialchars($project['id']); ?>"><?php echo htmlspecialchars($project['project_name_bn']); ?> (<?php echo htmlspecialchars($project['project_name_en']); ?>)</option>
                         <?php endforeach; ?>
                       </select>
                     </div>
                     <div class="mb-2">
