        ...
        <div class="row g-4 mb-4">
          <div class="col-md-12 text-center"> <?php if ($status === 'P'): ?> <div class="alert alert-danger mt-2" style="font-size:1rem;">
            ...
            <div class="col-md-12 mb-3">
              <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#memberPaymentModal">
                সদস্য পেমেন্ট তালিকা দেখুন (Show Member Payments)
              </button>
            </div>
          </div>
        </div>
...
<?php include_once __DIR__ . '/member_payment_modal.php'; ?>
